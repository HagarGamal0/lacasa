...
const CustomersList = () => {
  ...
  return (
    <HasAccess permissions="View Users" renderAuthFailed={<Unauthorized />} isLoading="loading...">
      <>
                ...
                <Card.Body className="pt-0 pb-0 sh-30 sh-lg-8">
                  <Row className="g-0 h-100 align-content-center" >
                    ...
                    <Col xs="6" lg="2" className="d-flex flex-column justify-content-center mb-2 mb-lg-0 order-5 order-lg-3">
                      ...
                      <div className="text-alternate">{item.addressbook.shipping.length > 0 ? item.addressbook.shipping[0].area : "No area available"}</div>
                    </Col>
                    ...
                    <Col xs="6" lg="2" className="d-flex flex-column justify-content-center mb-2 mb-lg-0 order-5 order-lg-4">
                      ...
                      <HasAccess permissions="Edit Users" renderAuthFailed={"You don't have access to edit users."} isLoading="loading...">
                        <NavLink to={`/users/detail/${item.id}`} className="text-truncate h-100 d-flex align-items-center body-link">
