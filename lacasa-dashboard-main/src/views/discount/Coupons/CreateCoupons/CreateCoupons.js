...
const CreateCoupon = () => {
    ...
    api
      ...
      .then(async (response) => {
        ...
        for (let i = 0; i < response.data.products.items.length; i += 1) {
          arr.push({
            label: response.data.products.items[i].name,
            value: response.data.products.items[i].id,
          });
        }
  ...
  useEffect(() => {
    if (document.getElementById("perEach")) {
      if (perEach === "each") {
  ...
  }, [perEach, document.getElementById("perEach")]);
        ...
        >
          ...
          <Row className="mt-3">
            ...
            <Col xl="6">
              ...
              {error && error.usage_limit ? (
                <small className="text-danger">{error.usage_limit}</small>
              ) : (
                ""
              )}
            </Col>
          ...
          <Row className="mt-3">
            <Col xl="6">
              ...
              />
              {error && error.usage_limit_per_user ? (
          ...
          <Row className="mt-3">
            ...
            <Col xl="6">
              ...
              <Form.Control
                type="date"
                {...register("expiry", { required: "This field is required." })}
              />
            </Col>
          </Row>
