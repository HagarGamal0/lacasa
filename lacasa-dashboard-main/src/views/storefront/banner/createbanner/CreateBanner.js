                      ...
                      <Row className="mt-5">
                        <Col xl="12">
                          <div className="mb-3">
                            ...
                            <Form.Control type="text" onChange={handleLink} />
                          </div>
                        </Col>
                      </Row>
                      <Row className="mt-5">
                        <Col xl="6">
                          <div className="mb-3">
                            ...
                            <Form.Control type="text" onChange={handleTitle} />
                          </div>
                        </Col>
                      ...
                      <Row className="mt-5">
                        <Col xl="6">
                          <div className="mb-3">
                            ...
                            <Form.Control type="number" onChange={handleOrder} />
                          </div>
                        </Col>
                      </Row>
                      <Row className="mt-5">
