...
class Create extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'designer_identity' => 'nullable|image',
            // 'designer_identity' => 'required|array',
            'commerical_registeration' => 'nullable|image',
            // 'commerical_registeration' => 'required|array',
        ...
        foreach ($langs as $lang) {
            $rules['company_name.' . $lang->locale] = [
                'nullable', 'string',
                'min:2', 'max:100',
                Rule::unique('designer_translations', 'company_name')->where('locale', $lang->locale)
            ];
    ...
    public function messages(): array
    {
        ...
        $langs = getLanguages();
        foreach ($langs as $lang) {
            $messages["company_name.$lang->locale.unique"] = __('validation.unique', ['attribute' => __('lang.company_name.en')]);
            $messages["company_name.$lang->locale.required"] = __('validation.required', ['attribute' => __('lang.company_name.en')]);
            $messages["company_name.$lang->locale.string"] = __('validation.string', ['attribute' => __('lang.company_name.en')]);
            $messages["company_name.$lang->locale.min"] = __('validation.min.string', ['attribute' => __('lang.company_name.en'), 'min' => '2']);
            $messages["company_name.$lang->locale.max"] = __('validation.min.string', ['attribute' => __('lang.company_name.en'), 'max' => '100']);
            $messages["job_title.$lang->locale.required"] = __('validation.required', ['attribute' => __('lang.job_title.en')]);
            $messages["job_title.$lang->locale.string"] = __('validation.string', ['attribute' => __('lang.job_title.en')]);
            $messages["job_title.$lang->locale.min"] = __('validation.min.string', ['attribute' => __('lang.job_title.en'), 'min' => '2']);
            $messages["job_title.$lang->locale.max"] = __('validation.min.string', ['attribute' => __('lang.job_title.en'), 'max' => '100']);
            $messages["bio.$lang->locale.string"] = __('validation.string', ['attribute' => __('lang.bio.en')]);
            $messages["address.$lang->locale.string"] = __('validation.string', ['attribute' => __('lang.address.en')]);
        }
        return $messages;
    }
}
