...
class CreateProductReviewRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'images.*' => 'nullable|mimes:png,jpg,svg|max:800',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'images.*.mimes'                => __('validation.mimes',['attribute'=>__('lang.images'),'values'=>'png,jpg,svg']) ,
            'images.*.max'                  => __('validation.max',['attribute'=>__('lang.images'),'max'=>'800']) ,
