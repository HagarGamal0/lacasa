...
class CreateContantUsRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'message.required'     =>__('validation.required',['attribute'=>__('lang.message')]),
            'message.string'       =>__('validation.string',['attribute'=>__('lang.message')]),
        ];
    }
}
